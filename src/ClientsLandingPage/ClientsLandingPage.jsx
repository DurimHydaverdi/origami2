  ...
  return (
    <div>
      <h1 className='home-text'>
        Origami Sports & Entertainment is a full-service management firm specializing in talent development within the sports and arts industries, with a focus on basketball. With 6 years of experience in the European-American basketball sector, we have achieved exceptional success, having participated in over 150 finalized global contracts spanning 4 continents. Our portfolio includes partnerships with prominent basketball leagues such as the EuroCup, BSL Turkey, ABA League, FIBA Europe Cup, and G-League, among others.
      </h1>
    </div>
  )
}
